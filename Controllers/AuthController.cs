...
using SportStore.Api.Models.ViewModel;

namespace SportStore.Api.Controllers
{
    public class AuthController : BaseApiController
    {
        public AuthController(DataContext dbContext, RoleManager<IdentityRole> roleManager,
        ...
        private async Task<IActionResult> RefreshToken(TokenRequestViewModel model)
        {
            try
            {
                ...
                DbContext.Tokens.Add(newRt);
                DbContext.SaveChanges();

                var response = CreateAccessToken(newRt.UserId, rt.Value);
